					...
					<div class="clearfix choose">
						...
						<div id="specification" class="summary-wrap clearfix">
                            ...
                            <#list  spec.attributeValue as val>
								  <dd><a :class="isSelected('${spec.attributeName}','${val}') ? 'selected' : ''"
                                         @click="selectSpecification('${spec.attributeName}','${val}')"
                                         href="javascript:;">${val}<span title="点击取消选择">&nbsp;</span></a></dd>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" @click="addNum(num+1)" class="increment plus">+</a>
										<a href="javascript:void(0)" @click="addNum(num-1)" class="increment mins">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a @click="addToCart()" href="cart.html" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
